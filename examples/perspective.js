...
var _perspectiveCommon = __webpack_require__(71);
...
var __SCRIPT_PATH__ = new _perspectiveCommon.ScriptPath();

// IE bug
if ((0, _perspectiveCommon.detectIE)() && window.location.href.indexOf(__SCRIPT_PATH__.host()) === -1) {
...
_worker.prototype._start_cross_origin = function () {
...
_worker.prototype._start_cross_origin_asmjs = function () {
...
_worker.prototype._start_cross_origin_wasm = function () {
...
_worker.prototype._start_same_origin = function () {
    var dir = typeof WebAssembly === "undefined" ? 'asmjs' : 'wasm_async';
...
_worker.prototype._handle = function (e) {
    if (!this._worker.initialized.value) {
...
_worker.prototype.table = function (data, options) {
...
module.exports = {
    worker: function worker() {
        if (window.location.href.indexOf(__SCRIPT_PATH__.host()) === -1 && (0, _perspectiveCommon.detectIE)()) {
            return perspective;
        }
        return new _worker();
    },
 ...
 */
function registerElement(template, proto) {
    proto.attributeChangedCallback = {
        value: function value(name, old, _value) {
            if (name[0] !== "_") {
                this[name] = _value;
            }
        }
    ...
    document.registerElement(name, {
        prototype: (0, _create2.default)(HTMLElement.prototype, proto)
    });
}
